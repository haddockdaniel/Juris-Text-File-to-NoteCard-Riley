namespace JurisUtilityBase
{
    partial class UtilityBaseMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelDescription.Text = "Extracts party types and party names from an Excel file and adds them as notecard" +
    "s for matters";
            // 
            // statusGroupBox
            // 
            ...
            this.label1.Text = "This utility adds note cards to matters based on a \r\nload file from LawBase. It a" +
    "lso updates matter remarks \r\n                        when a synopsys is given.";
            // 
            // UtilityBaseMain
            // 
